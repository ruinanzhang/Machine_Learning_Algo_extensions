...
def train(X,y_dash,num_classes = 10, lr = 0.01, beta1 = 0.95, beta2 = 0.99, img_dim = 8, img_depth = 1, f = 2, num_filt1 = 8, num_filt2 = 8, batch_size = 32, num_epochs = 2, save_path = 'save.pkl'):
    ...
    if img_dim ==28:
        ...
        f = 2
        f1, f2, w3, w4 = (num_filt1 ,img_depth,f,f), (num_filt2 ,num_filt1,f,f), (128,72), (10, 128)
    else:
